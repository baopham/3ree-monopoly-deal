...
const numberOfPropertiesRequired = 2

describe('PropertySet', function () {
  describe('#addCard', function () {
    it('should not allow to add a property once it is a full set', function () {
      const propertySet = new PropertySet(identifier, [PROPERTY_BLUE, PROPERTY_BLUE], numberOfPropertiesRequired)
    ...
    it('should allow to add a property if it is not a full set', function () {
      const propertySet = new PropertySet(identifier, [PROPERTY_BLUE], numberOfPropertiesRequired)
    ...
    it('should allow to add HOTEL if there is a HOUSE', function () {
      const propertySet = new PropertySet(identifier, [PROPERTY_BLUE, PROPERTY_BLUE, HOUSE], numberOfPropertiesRequired)
